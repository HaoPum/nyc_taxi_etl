...
def process_trip_cdc_stream(spark):
    ...
    def process_batch(batch_df, batch_id):
        ...
        taxi_zones_df = spark.table("iceberg.reference.taxi_zones").select("location_id", "latitude", "longitude")
        ...
        windowed_aggs.show(truncate=False)
    ...
    query = trip_details.writeStream \
        ...
        .toTable("iceberg.realtime.trip_aggregations")
