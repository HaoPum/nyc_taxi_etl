...
#             raise ValueError("Bucket 'lakehouse' is not exist.")
        
#         print("Bucket 'lakehouse' tồn tại và sẵn sàng")
#         return True
#     except Exception as e:
#         print(f"Lỗi khi kiểm tra MinIO bucket: {e}")
#         raise  # Re-raise exception để task fail
...
spark_location_etl_task = SparkSubmitOperator(
    ...
    application_args=['/opt/airflow/data/locations/nyc_taxi_zones.json'],
    conn_id='spark_default',
    spark_binary='/opt/bitnami/spark/bin/spark-submit', 
    conf={
        'spark.master': 'spark://spark-master:7077',
